    ...
    <div class="mt-10">
        <main>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                    ...
                    <span class="block text-indigo-200">day</span>
                    </h1>
                    ...
                    <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                        <Link :href="route('register')" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-700 bg-white hover:bg-indigo-50 sm:px-8">
                        Signup Free
                        </Link>
                        <Link :href="route('login')" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-500 bg-opacity-60 hover:bg-opacity-70 sm:px-8">
                        Log in
                        </Link>
                    </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                ...
                Trusted by over 2 people
                </p>
                <div class="mt-6 grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-3">
                <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 text-2xl text-bold">
                    You
                </div>
                <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 text-2xl text-bold">
                    Me
            ...
            <div class="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
                ...
                Task list support built for efficiency
                </h2>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Unlimited Tasks</h3>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Unlimited Lists</h3>
                    <p class="mt-2 text-base text-purple-200">
                        Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.
                    </p>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Signup Free</h3>
                    <p class="mt-2 text-base text-purple-200">
                        Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.
                    </p>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Add Attachments</h3>
                    <p class="mt-2 text-base text-purple-200">
                        Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.
                    </p>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Plan For Tasks</h3>
                    <p class="mt-2 text-base text-purple-200">
                        Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.
                    </p>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Color Coding</h3>
                    <p class="mt-2 text-base text-purple-200">
                        Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.
                    </p>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Mark Things Done</h3>
                    <p class="mt-2 text-base text-purple-200">
                        Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.
                    </p>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <h3 class="text-lg font-medium text-white">Customized Layouts</h3>
                    <p class="mt-2 text-base text-purple-200">
                        Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.
                    </p>
                    </div>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
                ...
                <p class="mt-3 text-3xl font-extrabold text-white">Get actionable data that will help you organize</p>
                ...
                <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
                    <p>
                    <span class="block text-2xl font-bold text-white">110%</span>
                    <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">Efficiency</span> use laoreet amet lacus nibh integer quis.</span>
                    </p>

                    <p>
                    <span class="block text-2xl font-bold text-white">24/7</span>
                    <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">Availability</span> lacus nibh integer quis.</span>
                    </p>

                    <p>
                    <span class="block text-2xl font-bold text-white">200%</span>
                    <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">Freedom</span> laoreet amet lacus nibh integer quis.</span>
                    </p>

                    <p>
                    <span class="block text-2xl font-bold text-white">12M+</span>
                    <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">Hours Saved</span> lacus nibh integer quis.</span>
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:flex lg:items-center lg:justify-between">
                ...
                <Link :href="route('login')" class="flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-purple-700 hover:to-indigo-700">
                    Learn more
                </Link>
                <Link :href="route('register')" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-800 bg-indigo-50 hover:bg-indigo-100">
                    Get started
                </Link>
                </div>
            </div>
        ...
        <footer class="bg-gray-50" aria-labelledby="footer-heading">
            ...
            <div class="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
                ...
                &copy; {{ new Date().getFullYear() }} A-5, LLC. All rights reserved.
                </p>
            </div>
            </div>
        </footer>
